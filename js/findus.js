...
window.onload=function(){
    ...
    function createMap(){
        ...
        var point = new BMap.Point(113.64437,34.77013);//定义一个中心点坐标
    ...
    //标注点数组
    var markerArr = [{title:"覔不散",content:"瑞光路 瑞光创意工场壹号院四楼 A420<br>电话:400-999-3110",
    ...
    function createIcon(json){
        var icon = new BMap.Icon("image/findus/588017829848936993.png",
